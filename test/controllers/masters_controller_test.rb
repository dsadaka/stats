...
class MastersControllerTest < ActionController::TestCase
  ...
  test "should create master" do
    assert_difference('Master.count') do
      post :create, master: { birthYear: @master.birthYear, nameFirst: @master.nameFirst, nameLast: @master.nameLast, playerID: @master.playerID }
    end
  ...
  test "should update master" do
    patch :update, id: @master, master: { birthYear: @master.birthYear, nameFirst: @master.nameFirst, nameLast: @master.nameLast, playerID: @master.playerID }
    assert_redirected_to master_path(assigns(:master))
  end
